...
/**
 * Rare UI `matrix-orb` (https://rareui.com) — Copyright (c) 2026 Swami Malode.
 * Licensed MIT + Commons Clause License Condition v1.0 + Attribution; see components/rare-ui/LICENSE.
 * Adapted for Qalaa: Pantone-neutral surfaces, lime default colour, `cn` import.
 */
...
export const MatrixOrb = ({
  ...
  return (
    ...
    >
      ...
      />
      <span role="status" aria-live="polite" className="mono-data text-[11px] text-text-3">
