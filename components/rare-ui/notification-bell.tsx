...
/**
 * Rare UI `notification-bell` (https://rareui.com) — Copyright (c) 2026 Swami Malode.
 * Licensed MIT + Commons Clause License Condition v1.0 + Attribution; see components/rare-ui/LICENSE.
 * Adapted for Qalaa: Pantone-neutral surfaces, lime badge colour, `cn` import.
 */
...
const SURFACE = "bg-bg-1";
const GLYPH = "text-text-2";
    ...
    <AnimatePresence initial={false}>
      {total > 0 && (
        ...
        >
          {!dot && (
            <span
              className="flex font-semibold leading-none tracking-tight text-carbon"
