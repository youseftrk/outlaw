...
- **Checks**: `npx tsc --noEmit` clean · `npm test` 54/54 (blind boundary clean) · `npm run build` green (37 API routes incl. `/api/messages/inbound` + `/api/settings/delivery/test`), all pages prerender.
