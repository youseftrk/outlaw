...
description: >
  ...
  Space Grotesk in lowercase weight 900 treated as graphic primitive, JetBrains Mono chrome (uppercase,
...
typography:
  ...
  h3:      { fontFamily: "Space Grotesk", cqw: 2.8, weight: 600, lineHeight: 1.2, lower: true }
  ...
  stat-value:{ fontFamily: "Space Grotesk", cqw: 5.5, weight: 700, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Space Grotesk", cqw: 7.5, weight: 700, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "Space Grotesk", cqw: 7.5, weight: 700, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "Space Grotesk", cqw: 10.0, weight: 700, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "Space Grotesk", cqw: 10.5, weight: 700, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "Space Grotesk", cqw: 13.0, weight: 700, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
- **Fonts** — already set to **Space Grotesk** (display) / **JetBrains Mono** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{300, 400, 500, 600, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
- **Space Grotesk + JetBrains Mono via Google Fonts**; Noto Sans SC is the CJK fallback (the lowercase-display signal has no CJK equivalent — the two-register color system carries the identity, per the source).
