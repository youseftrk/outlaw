var PaperShaders = (() => {
  ...
  // papershaders-entry.js
  var papershaders_entry_exports = {};
  __export(papershaders_entry_exports, {
    ...
    getShaderNoiseTexture: () => getShaderNoiseTexture,
    grainGradientFragmentShader: () => grainGradientFragmentShader
  });
...
`;
  ...
  var fallbackColor = [0.5, 0.5, 0.5, 1];
  ...
  return __toCommonJS(papershaders_entry_exports);
})();
